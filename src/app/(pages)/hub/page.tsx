...
export default function Hub(){
    ...
    return (
        <main className="flex flex-col items-center justify-between">
            <h1 className="text-2xl text-center text-zinc-50 rounded-lg p-5 transition 1s bg-black dark:bg-zinc-900 mb-20">Hello0o, <strong>{name !== "" ? name : "Quizz User"}</strong></h1>
            <div>
